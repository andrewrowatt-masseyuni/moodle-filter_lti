...
$string['customprefixcss_desc'] = 'Custom CSS styles to apply to LTI embeds. You can use this to style embedded content based on custom prefixes or other attributes.';
